    ...
    <div className="p-6 bg-gray-100">
      ...
      <div className="flex flex-wrap justify-center -mx-4">
        ...
        <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 px-4 mb-8">
          <div className="rounded-lg p-4 shadow-md flex flex-col h-full">
            ...
            <button onClick={() => bookAmbulance('Personal Ambulance')} className="bg-blue-500 text-white font-semibold px-4 py-2 rounded hover:bg-blue-600 mt-auto">
              Book Ambulance
            </button>
          </div>
        </div>
