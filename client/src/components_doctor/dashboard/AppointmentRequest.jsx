            ...
            <tbody>
              {AppointmentData.map((appointment, index) => (
                <tr key={appointment.id} className="border-b">
                  <td className="py-2 text-left">{appointment.id}</td>
                  <td className="py-2">
                  ...
                  <td className="py-2 text-left">{appointment.date}</td>
                  <td className="py-2 text-left">{appointment.reason}</td>
                  <td className="py-2 text-left">{appointment.type}</td>
